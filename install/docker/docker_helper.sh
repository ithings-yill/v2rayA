...
wget https://github.com/ithings-yill/v2rayA/releases/download/vRealv2rayAVersion/v2raya_linux_"$v2raya_arch"_Realv2rayAVersion
wget https://github.com/ithings-yill/v2rayA/releases/download/vRealv2rayAVersion/v2raya_core_linux_"$v2raya_arch"_Realv2rayAVersion
